...
// **Gestión del Roadmap Tecnológico**: Supervisión continua de la evolución del producto, adaptando la arquitectura y las herramientas según el crecimiento y las necesidades del mercado.

// **Estandarización y Cumplimiento (IEC 62443)**: Implementación de procesos de diseño seguro y estándares industriales para garantizar la robustez, ciberseguridad y escalabilidad de los activos tecnológicos.

// **Selección y Gestión de Partners**: Identificación, evaluación y gestión de proveedores tecnológicos y colaboradores externos para optimizar recursos y asegurar la excelencia técnica.

// **Mentoría y Cultura de Innovación**: Apoyo recurrente al equipo técnico para fomentar mejores prácticas de ingeniería, metodologías ágiles y una mentalidad orientada a la resolución de problemas.
//     `
//   },
  {
    id: 's3',
    title: 'Auditoría de Tech Due Diligence (Auditoría Técnica para Inversores)',
