...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: 'Diseño de sistemas robustos, escalables y mantenibles adaptados a las necesidades técnicas más exigentes.',
        ...
        {filteredPosts.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            {filteredPosts.map(post => (
              <div key={post.id} className="flex flex-col sm:flex-row gap-6 group cursor-pointer" onClick={() => console.log('Navegar a post:', post.id)}>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        {currentView === 'products' && <ProductsView setCurrentView={setCurrentView} />}
        {currentView === 'blog' && (
          <BlogView 
