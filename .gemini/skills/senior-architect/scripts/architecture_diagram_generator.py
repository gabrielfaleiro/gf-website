...
Generates architecture diagrams and reports for project analysis.
Run from the skill directory: python scripts/architecture_diagram_generator.py <project-path>
