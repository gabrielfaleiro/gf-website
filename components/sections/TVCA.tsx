...
const vcardHref = `data:text/vcard;charset=utf-8,${encodeURIComponent(vcardString)}`;
  ...
  <ul className="space-y-3">
    ...
    <li>
      <a 
        href={`tel:${TVCA_DATA.phone.replace(/\s+/g, '')}`} 
        className="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-custom group cursor-pointer"
      >
      ...
      >
        ...
        <section>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <span className="mb-2 text-gray-600 group-hover:text-accent transition-transform group-hover:scale-110">
                    {/* Icono de LinkedIn */}
                    <svg 
                      className="w-6 h-6" 
                      fill="currentColor" 
