        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-16">
          <div className="order-2 md:order-1 text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 leading-tight mb-6 tracking-tighter">
              Soluciones <span className="text-blue-900">estratégicas</span> para profesionales
            </h1>
            <p className="text-xl text-gray-500 mb-10 max-w-lg leading-relaxed mx-auto md:mx-0">
              <strong className="font-extrabold text-black">Arquitecto de Innovación Estratégica y Transformación Digital</strong> <br />
              Conecto la visión de profesionales con soluciones tecnológicas y estrategias de impacto real.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 text-center md:text-left">
              ...
              <h3 className="text-3xl font-extrabold text-gray-900 mb-6 tracking-tight">Escucha mi <span className="text-blue-900">Podcast</span></h3>
              <p className="text-gray-500 text-lg leading-relaxed mb-8">
                Reflexiones sobre innovación, emprendimiento y tecnología. Suscríbete para no perderte ningún capítulo.
              </p>
